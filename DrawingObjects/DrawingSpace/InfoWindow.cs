...
namespace TheGameDrawing.DrawingSpace
{
	class InfoWindow
	{
		public static void Draw()
		{
			...
			TextRenderer.DrawText(InformationWindow.LabStats, Color.Gold);
			...
			TextRenderer.DrawText(InformationWindow.LabCurrentPrice, Color.FromArgb(20, 240, 20));
			if (InformationWindow.IsShow)
			{
                ...
                if (InformationWindow.GetTypeSelectedObj() == "Alien")
                    tex = Textures.aliens[ind [0]][ind[1]];
				...
				temp = tex.GetLevelDescription(0);
				Drawing.OurSprite.Draw2D(tex, Point.Empty, 0, new Point(InformationWindow.RectIcon.X + InformationWindow.RectIcon.Width / 2 - temp.Width / 2, InformationWindow.RectIcon.Y + InformationWindow.RectIcon.Height / 2 - temp.Height / 2), Color.White);
				TextRenderer.DrawText(InformationWindow.LabFirstInfo, Color.White);
				TextRenderer.DrawText(InformationWindow.LabSecondInfo, Color.Gray);
			}
