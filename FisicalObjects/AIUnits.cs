...
namespace FisicalObjects
{
	public static class AIUnits
	{
		...
		public static void CreateWorld()
		{
            ...
            AliensField.CreateWorld(WorldSize / 2);
		...
		public static void Inicialize(int worldsize,int prad)
		{
            ...
            AliensField.Inicialize(WorldSize);
			MineAvalible.Load();
		}
		...
		public static void Process()
		{
			...
			if (Time >= WaveTime)
			{
                ...
                AliensField.CreateWave(AlienCount);
                AlienCount = (int)(WaveMultipler * AlienCount + (WaveAdder + WaveAdderModifer * WaveCount));
            }
			else
				Time++;
		}
        ...
        {
            return AliensField.GetTransAliens();
        }
		...
		public static TransInfo GetObject(Point pos)
		{
            ...
            // Корабль
            ind = AliensField.GetAlien(pos);
            if (ind > -1)
                return AliensField.GetTransInfo(ind);
			return null;
		}
		...
		public static TransInfo CheckObject()
		{
			...
			if (data == null)
				data = AsterField.CheckRef();
            if (data == null)
                data = AliensField.CheckRef();
			if (data == null)
        ...
        public static int[][] GetSpcAliensInfo()
        {
            int[][] info = new int[2][];
            info[0] = AlienAvailible.Counts;
            info[1] = AlienAvailible.TexSizes;
            return info;
        }
        ...
        public static string[] GetAliensTypes()
        {
            return AlienAvailible.Types;
        }
        ...
        public static List<int> GetAlienRads()
        {
            List<int> rads = new List<int>();
            int[] alrads = AlienAvailible.GetAllRads();
            foreach (int rad in alrads)
                rads.Add(rad);
            return rads;
        }
	}
